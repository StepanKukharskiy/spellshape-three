  ...
  "procedures": [
    {
      ...
      "steps": [
        ...
        {
          "action": "transform",
          "helper": "twistGeometry",
          "params": {
            "geometry": "core_tower",
            "angle": "$twistPerFloor * ($twistEndFloor - $twistStartFloor)",
            "axis": [0, 1, 0]
          },
          "store": "core_twisted"
        },
        ...
        {
          "action": "createGeometry",
          "helper": "repeatLinear3d",
          "params": {
            "geometry": "slab_single",
            "count": "$floors",
            "spacing": "$floorHeight",
            "axis": "y"
          },
        ...
        },
        {
          ...
          "helper": "createBox",
          "params": {
            "width": "$coreWidth * 2 * $slabExpansion / $panelsPerSide",
        ...
        },
        {
          ...
          "params": {
            "geometry": "panel_unit",
            "count": "$panelsPerSide",
            "spacing": "$coreWidth * 2 * $slabExpansion / $panelsPerSide",
            "axis": "x",
            "centered": true
          },
          "store": "panels_row"
